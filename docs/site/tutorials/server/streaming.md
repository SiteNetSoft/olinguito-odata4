...
Available with *Olinguito 4.2.0 (and newer).*
...
And for Olinguito exists the `ODataContentWriteErrorCallback` which is described in the chapter *Exception/Error Handling*.
