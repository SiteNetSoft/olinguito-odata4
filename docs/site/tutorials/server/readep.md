...
Such operations will be the focus of the Olinguito V4 tutorial no. 3
...
Follow [Tutorial Part 1: Read Entity Collection](read.md), which also covers setting up the environment and running the service.


# 2. Preparation

Follow the [Tutorial Part 1: Read Entity Collection](read.md) or import the the tutorial form subdirectory [*\samples\tutorials\p1_read*](../prerequisites.md) into your Eclipse workspace.  
...
Whenever such a URL is requested, the Olinguito library will delegate the request to an implementation of the Interface `EntityProcessor`.
...
The interface `org.sitenetsoft.olinguito.server.api.processor.EntityProcessor` has 5 methods to implement:
...
![datamodel](../../images/tutorials/readep/model1.png  "The OData model")
...
The interface `org.sitenetsoft.olinguito.server.api.processor.PrimitiveProcessor` has 4 methods to implement:
...
In the next tutorial ([Part 3: Write](write.md)) we will learn how to implement write operations, i.e. create, update and delete of an entity.
