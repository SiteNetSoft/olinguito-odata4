...
Prerequisites for this Appendix is an installed Maven (Version 3.x) and access to the [Maven Central Repository](https://www.maven.org)
...
To create a Maven project without Eclipse, execute the following command on command line:
    ...
    mvn archetype:generate \
      -DgroupId=org.sitenetsoft.olinguito \
...
To implement the Demo Service see section [4. Implementation](read.md#4-implementation) in the tutorial.
