...
As a shortcut you should checkout the prepared tutorial project in the [git repository](https://github.com/sitenetsoft/olinguito-odata4) in folder /samples/tutorials/p9_action_preparation.
...
As described in the previous tutorials, the type of the response determines which processor interface will be called by the Olinguito library. It is **important to know, that functions are dispatched to the traditional processor interfaces**.
