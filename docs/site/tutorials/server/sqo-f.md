...
![AllProductsWithoutFilter](../../images/tutorials/sqo_f/no_filter.png  "All products without filter")
...
![ProductsWithFilter](../../images/tutorials/sqo_f/filter_applied.png  "Products with applied $filter")
...
![AbstractSyntaxTree](../../images/tutorials/sqo_f/ast.png  "Abstract syntax tree of the filter expression “Price lt 2000 and contains(Description,’Notebook’)")

Key  
![AbstractSyntaxTree](../../images/tutorials/sqo_f/keyAST.png  "Key abstract syntax tree")
...
Olinguito uses the vistor pattern to traverse the AST. Each of these actions is mapped to one method of the ExpressionVistor interface. You can see the name of the methods in last column of table 1. As service developers we have to implement this methods but we do not have to take care about calling them. The libaray will call the proper method and we have only to calculate the result.
...
implement the Interface `org.sitenetsoft.olinguito.server.api.uri.queryoption.expression.ExpressionVisitor`.
