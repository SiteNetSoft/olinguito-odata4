...
![CategoryCollection](../../images/tutorials/navigation/browser_categories.JPG  "The Category collection")
...
![CategoryEntity](../../images/tutorials/navigation/browser_categories1.jpg  "Read single Category entity")
...
![ProductsOfCategory](../../images/tutorials/navigation/browser_categories1_products.jpg  "After navigating from a  Category to the related Products")
...
Same prerequisites as in [Tutorial Part 1: Read Entity Collection](read.md) and [Tutorial Part 2: Read Entity](readep.md) as well as basic knowledge about the concepts presented in both tutorials.

---

# 2. Preparation

Follow [Tutorial Part 1: Read Entity Collection](read.md) and [Tutorial Part 2: Read Entity](readep.md) or as shortcut import *Part 2: Read Entity, Read Property* into your Eclipse workspace.
...
![ODataModelNavigation](../../images/tutorials/navigation/model.JPG  "Our OData Model with link between 2 Entity Types")
...
![CategoryMetadata](../../images/tutorials/navigation/browser_metadataCategory.JPG  "The definition of a Navigation Property in the $metadata document")
...
In the first chapter, we’ve already learned that there’s a special interface responsible for navigation segments, the `org.sitenetsoft.olinguito.server.api.uri.UriResourceNavigation`
