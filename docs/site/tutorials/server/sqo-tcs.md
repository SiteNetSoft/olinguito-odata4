...
![AllProductsNoQueryOption](../../images/tutorials/sqo_tcs/responseFull.jpg  "The full list of Products")
...
![ProductsWith$top](../../images/tutorials/sqo_tcs/responseTop2.jpg  "The first 2 entries of the list of Products")
...
![ProductsWith`$skip`](../../images/tutorials/sqo_tcs/responseSkip2.jpg  "Skipping the first 2 entries of the list of Products")
...
![ProductsWith`$count`](../../images/tutorials/sqo_tcs/responseCount.jpg  "The full list of Products with the count added in the payload")


**Note:**
TThe final source code can be found in the project [git repository](https://github.com/sitenetsoft/olinguito-odata4).
...
Same prerequisites as in [Tutorial Part 1: Read Entity Collection](read.md)
 and [Tutorial Part 2: Read Entity](readep.md) as well as basic knowledge about the concepts presented in both tutorials.

___

# 2. Preparation

Follow [Tutorial Part 1: Read Entity Collection](read.md)
 and [Tutorial Part 2: Read Entity](readep.md) or as shortcut import the project attached to Tutorial Part 2 into your Eclipse workspace.
...
**Note:**
We don’t need to check if the value of the `$count` is incorrect (e.g. `$count=xxx`), as this is handled by the _Olinguito OData V4_ library.
