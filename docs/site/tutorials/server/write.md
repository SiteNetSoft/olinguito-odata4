...
This tutorial guides you through the steps required to write an OData Service based on the Olinguito OData 4.0 Library for Java (based on current release which can be got via the [Download-Page](https://github.com/sitenetsoft/olinguito-odata4/releases)).

In the first two tutorials ([Read Collection](read.md) and [Read Entity](readep.md)), we’ve learned how to build a simple OData service that supports read operations for collection, single entity and property.
...
Follow [Tutorial Part 1: Read Entity Collection](read.md) and [Tutorial Part 2: Read Entity](readep.md) or as shortcut import the project attached to *Tutorial Part 2* into your Eclipse workspace.
...
The Olinguito library takes this user request, serializes the request body and invokes the corresponding method of our processor class.
