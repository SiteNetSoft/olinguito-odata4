...
![Test](../../images/tutorials/batch/request.png)
...
Create a new class `myservice.mynamespace.service.DemoBatchProcessor`. The class should implement the interface `org.sitenetsoft.olinguito.server.api.processor.BatchProcessor`.
