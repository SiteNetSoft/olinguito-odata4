...
Create a new Maven project. Execute the following command in your shell.
    ...
    mvn archetype:generate -DgroupId=org.sitenetsoft.olinguito -DartifactId=odata-server-sample -DarchetypeArtifactId=maven-archetype-webapp -DinteractiveMode=false

The Olinguito library consists of different sub projects. The dependencies are shown in figure 1 below:

![Figure1: Olinguito library dependencies](../../images/tutorials/common/dependencies.png)
...
Next, setup up the web project by replacing the `web.xml`.
    ...
    <display-name>Olinguito OData 4.0 Sample Service</display-name>
    ...
    <servlet>
      ...
      <servlet-class>org.sitenetsoft.olinguito.server.sample.CarsServlet</servlet-class>
...
Each Olinguito OData service consists of several parts.

 * **EdmProvider**
Delivers an abstract definition of the service.
* **DataProvider**
The data provider connects the Olinguito library with the data source. In this basic tutorial, we will use static data. In real world application, the data provider will may establish a connection to a database. There a no constraints how a DataProvider has to be build.
* **Processor**
...
![Figure 2: Data model](../../images/tutorials/common/er.png)
...
Create a new class called `CarsEdmProvider` that inherits from `EdmProvider`
    ...
    import org.sitenetsoft.olinguito.server.api.edm.provider.EdmProvider;
...
Create a new class `DataProvider`.
    ...
    package org.sitenetsoft.olinguito.server.sample.data;
    ...
    import org.sitenetsoft.olinguito.commons.api.data.EntitySet;
    import org.sitenetsoft.olinguito.commons.api.data.Property;
    import org.sitenetsoft.olinguito.commons.api.data.ValueType;
    import org.sitenetsoft.olinguito.commons.core.data.EntityImpl;
    import org.sitenetsoft.olinguito.commons.core.data.EntitySetImpl;
    import org.sitenetsoft.olinguito.commons.core.data.PropertyImpl;
...
Create a new class `SampleClient`
    ...
    package org.sitenetsoft.olinguito.client.sample;

    import java.net.URI;
    import java.util.List;

    import org.sitenetsoft.olinguito.client.api.communication.response.ODataRetrieveResponse;
    import org.sitenetsoft.olinguito.client.api.v4.ODataClient;
    import org.sitenetsoft.olinguito.client.core.ODataClientFactory;
    import org.sitenetsoft.olinguito.commons.api.domain.v4.ODataEntity;
    import org.sitenetsoft.olinguito.commons.api.domain.v4.ODataEntitySet;
    import org.sitenetsoft.olinguito.commons.api.edm.Edm;
    import org.sitenetsoft.olinguito.commons.api.format.ODataFormat;
...
Create a new class *Main*.
    ...
    import org.sitenetsoft.olinguito.commons.api.domain.ODataComplexValue;
    import org.sitenetsoft.olinguito.commons.api.domain.v4.ODataEntity;
    import org.sitenetsoft.olinguito.commons.api.domain.v4.ODataProperty;
    import org.sitenetsoft.olinguito.commons.api.edm.Edm;
