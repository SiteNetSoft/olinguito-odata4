...
This Tutorial shows how to use the Olinguito Library for CRUD operations on an existing OData Service.
...
For creating a simple odata service refer the section Basic Tutorial: Create an OData V4 Service with Olinguito in Olinguito V4 tutorial
...
It also requires an odata service. This sample uses the Cars service which can be found under samples/server under olingo [git repository][1]. Build the project and deploy the war on a server. Follow the [Guide - To fetch the tutorial sources][2] to import the sample server project.
 ...
 1. Create a sample maven project and name it OlingutitoSampleApp.
 2. Create a new package org.sitenetsoft.olinguito.samples.client under this
    project.
 3. Create a class OlingutitoSampleApp.java under package
    org.sitenetsoft.olinguito.samples.client.
 ...
 6. Run OlingutitoSampleApp against sample Service
...
This fact is important because the Olinguito library requires the metadata for serialization and de-serialization of the data of an entity (e.g. the validation of the data is done against the EDM provided metadata). Hence the first step in this sample is to read the whole EDM of an OData Service.
...
For read and de-serialize of the EDM this is all what have to be done and the resulting EDM instance than can be used for necessary serialization and de-serialization in combination of CRUD operations supported by Olinguito library.
...
### Delete
For deletion of an entry just a DELETE request is necessary on the URI of the entity. Hence the Olinguito is not necessary to serialize or de-serialize anything for this use case.
              ...
              <plugin>
                ...
                <executions>
                  <execution>
                    ...
                    <configuration>
                      <mainClass>org.sitenetsoft.olinguito.samples.client.OlingutitoSampleApp</mainClass>
                    </configuration>
                  </execution>
                </executions>
              </plugin>
...
### OlingutitoSampleApp.java
     ...
     *
     */
    public class OlingutitoSampleApp {
      private ODataClient client;
      
      public OlingutitoSampleApp() {
        client = ODataClientFactory.getClient();
      }
    
      public static void main(String[] params) throws Exception {
        OlingutitoSampleApp app = new OlingutitoSampleApp();
