...
* See the link:architecture.adoc[Architecture Overview] for understanding the module structure
* Explore the `samples/tutorials/` directory for step-by-step tutorials
* Check `samples/server/` for a complete server example
* Review the OData V4 specification at http://www.odata.org/documentation/
