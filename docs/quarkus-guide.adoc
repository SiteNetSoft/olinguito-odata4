...
|`olinguito.odata.path`
|`/odata`
|Base path for the OData service

|`olinguito.odata.debug`
|`false`
|Enable debug output (?odata-debug=json)

|`olinguito.odata.namespace`
|`OData`
|Default namespace for the service

|`olinguito.odata.max-page-size`
|`1000`
|Maximum entities per page

|`olinguito.odata.batch.enabled`
|`true`
