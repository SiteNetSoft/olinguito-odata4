 ...
 * under the License.
 *
 * Copyright 2026 SiteNetSoft - Added isPrimitive(), isEnum(), isGeospatial() methods
 */
...
public interface EdmConstantExpression extends EdmExpression {
  ...
  /**
   * Checks if this expression represents a primitive value.
   * @return true if this expression holds a primitive value
   */
  default boolean isPrimitive() {
    return asPrimitive() != null;
  }

  /**
   * Checks if this expression represents an enum value.
   * @return true if this expression holds enum member(s)
   */
  default boolean isEnum() {
    return asEnumMembers() != null && !asEnumMembers().isEmpty();
  }

  /**
   * Checks if this expression represents a geospatial value.
   * @return true if this expression holds a geospatial value
   */
  default boolean isGeospatial() {
    return asGeospatial() != null;
  }
