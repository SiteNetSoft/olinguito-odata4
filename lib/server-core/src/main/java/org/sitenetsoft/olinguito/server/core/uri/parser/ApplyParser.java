...
import org.sitenetsoft.olinguito.server.api.uri.queryoption.apply.CustomFunction;
import org.sitenetsoft.olinguito.server.api.uri.queryoption.apply.GroupBy;
...
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.AggregateExpressionImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.AggregateImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.BottomTopImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.ComputeExpressionImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.ComputeImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.ConcatImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.CustomFunctionImpl;
...
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.ExpandImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.FilterImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.GroupByImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.GroupByItemImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.IdentityImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.OrderByImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.SearchImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.SkipImpl;
import org.sitenetsoft.olinguito.server.core.uri.queryoption.apply.TopImpl;
