...
public class SchemaVersionOptionImpl extends SystemQueryOptionImpl implements SchemaVersionOption {

  public SchemaVersionOptionImpl() {
    setKind(SystemQueryOptionKind.SCHEMAVERSION);
  }
  ...
  public SchemaVersionOptionImpl setValue(final String schemaVersionValue) {
    setText(schemaVersionValue);
    return this;
  }
