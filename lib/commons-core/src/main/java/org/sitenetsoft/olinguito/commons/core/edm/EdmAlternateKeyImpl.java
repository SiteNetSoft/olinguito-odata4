...
public class EdmAlternateKeyImpl implements EdmAlternateKey {
  ...
  private final List<EdmAlternateKeyPropertyRef> propertyRefs;

  public EdmAlternateKeyImpl(final List<EdmAlternateKeyPropertyRef> propertyRefs) {
    this.propertyRefs = List.copyOf(propertyRefs);
  }

  @Override
  public List<EdmAlternateKeyPropertyRef> getPropertyRefs() {
    return propertyRefs;
  }
}
