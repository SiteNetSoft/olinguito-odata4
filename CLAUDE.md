...
- **OData 4.01 (Tier 5, Wave 1)**: matchesPattern, Prefer: omit-values=nulls, /$query POST-body query options (server + client); Wave 2: $schemaversion, optional function parameters; Wave 3: key-as-segment, alternate keys
