...
public interface ContactDetails
    extends org.sitenetsoft.olinguito.ext.proxy.api.ComplexType<ContactDetails>,
        StructuredQuery<ContactDetails> {
  ...
  interface Annotations {
    ...
    @AnnotationsForProperty(name = "FirstContacted",
        type = "Edm.Binary")
    Annotatable getFirstContactedAnnotations();

    @AnnotationsForProperty(name = "LastContacted",
        type = "Edm.DateTimeOffset")
    Annotatable getLastContactedAnnotations();

    @AnnotationsForProperty(name = "Contacted",
        type = "Edm.Date")
    Annotatable getContactedAnnotations();

    @AnnotationsForProperty(name = "GUID",
        type = "Edm.Guid")
    Annotatable getGUIDAnnotations();

    @AnnotationsForProperty(name = "PreferedContactTime",
        type = "Edm.TimeOfDay")
    Annotatable getPreferedContactTimeAnnotations();

    @AnnotationsForProperty(name = "Byte",
        type = "Edm.Byte")
    Annotatable getByteAnnotations();

    @AnnotationsForProperty(name = "SignedByte",
        type = "Edm.SByte")
    Annotatable getSignedByteAnnotations();

    @AnnotationsForProperty(name = "Double",
        type = "Edm.Double")
    Annotatable getDoubleAnnotations();

    @AnnotationsForProperty(name = "Single",
        type = "Edm.Single")
    Annotatable getSingleAnnotations();

    @AnnotationsForProperty(name = "Short",
        type = "Edm.Int16")
    Annotatable getShortAnnotations();

    @AnnotationsForProperty(name = "Int",
        type = "Edm.Int32")
    Annotatable getIntAnnotations();

    @AnnotationsForProperty(name = "Long",
        type = "Edm.Int64")
