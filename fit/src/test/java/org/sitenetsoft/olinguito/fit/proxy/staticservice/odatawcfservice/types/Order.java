...
public interface Order
    extends Annotatable,
        org.sitenetsoft.olinguito.ext.proxy.api.EntityType<Order>, StructuredQuery<Order> {
  ...
  @Property(name = "OrderShelfLifes",
      ...
      collation = "",
      srid = "")
  PrimitiveCollection<BigDecimal> getOrderShelfLifes();

  void setOrderShelfLifes(PrimitiveCollection<BigDecimal> _orderShelfLifes);
