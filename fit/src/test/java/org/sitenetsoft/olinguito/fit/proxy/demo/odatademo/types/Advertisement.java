...
public interface Advertisement
  ...
  void uploadStream(EdmStreamValue stream);

  EdmStreamValue loadStream();
  ...
  interface Annotations {
    ...
    @AnnotationsForProperty(name = "AirDate",
        type = "Edm.DateTimeOffset")
    Annotatable getAirDateAnnotations();

    @AnnotationsForNavigationProperty(name = "FeaturedProduct",
        type = "ODataDemo.FeaturedProduct")
