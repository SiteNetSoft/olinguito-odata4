...
public final class EntityContainerInvocationHandler extends AbstractInvocationHandler {
  ...
  public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
    if (isSelfMethod(method)) {
      ...
      } else if (returnType.isAnnotationPresent(EntityType.class)) {
  ...
  public <NE extends org.sitenetsoft.olinguito.ext.proxy.api.EntityType<?>> NE newEntityInstance(final Class<NE> ref) {
  ...
  @SuppressWarnings("unchecked")
  public
  <T extends org.sitenetsoft.olinguito.ext.proxy.api.EntityType<?>, NEC extends EntityCollection<T, ?, ?>> NEC
  newEntityCollection(
          final Class<NEC> ref) {
